...
3. Within the same **mobile folder**, in the terminal run the following:
   - _**adb reverse tcp:8000 tcp:8000**_
   - _**npm install**_
   - _**npx react-native run-android**_
...
3. Once the device is booted up, within the same **mobile folder**, in the terminal run the following:
   - _**adb reverse tcp:8000 tcp:8000**_
   - _**npm install**_
   - _**npx react-native run-android**_
